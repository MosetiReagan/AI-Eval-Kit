...
describe('Baseline & Regression Detection', () => {
  const mockBaselineRun: EvaluationRun = {
    ...
    latencyStats: { avgMs: 100, medianMs: 95, p95Ms: 140, p99Ms: 150, minMs: 50, maxMs: 160 },
    totalTokens: { inputTokens: 500, outputTokens: 500, totalTokens: 1000 },
    totalCost: 0.002,
    cases: [
      { id: 'c1', case: { id: 'c1', input: 'test' }, passed: true, score: 1, latencyMs: 100, cost: 0.0002, evaluatorResults: {} },
      { id: 'c2', case: { id: 'c2', input: 'test' }, passed: true, score: 1, latencyMs: 100, cost: 0.0002, evaluatorResults: {} },
    ],
  };
  ...
  it('detects score drop regression exceeding threshold', () => {
    const currentRun: EvaluationRun = {
      ...
      cases: [
        { id: 'c1', case: { id: 'c1', input: 'test' }, passed: true, score: 1, latencyMs: 100, cost: 0.0002, evaluatorResults: {} },
        { id: 'c2', case: { id: 'c2', input: 'test' }, passed: false, score: 0.5, latencyMs: 100, cost: 0.0002, evaluatorResults: {} },
      ],
    };

    const manager = new BaselineManager();
    const comparison = manager.compare(currentRun, mockBaselineRun, { maxScoreDrop: 0.03 });
